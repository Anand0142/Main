...
ScrollTrigger.batch(".Slide_From_Left", {
    start: "top bottom-=100px",
    onEnter: elements => {
        gsap.fromTo(elements, transitions.SlideFromLeft.from, transitions.SlideFromLeft.to);
    },
    once: true
});

ScrollTrigger.batch(".Slide_From_Right", {
    start: "top bottom-=100px",
    onEnter: elements => {
        gsap.fromTo(elements, transitions.SlideFromRight.from, transitions.SlideFromRight.to);
    },
    once: true
});
